...
var thisScript = getScriptByString("gmmx.turbobytes");
var params = getParametersFromUrl(thisScript.src);
var DV = 'https://pixel.adsafeprotected.com/jload?anId=925211&advId=' + params.advertiser_id + '&campId=' + params.campaign_id + '&pubId=' + params.site_id + '&chanId=display&placementId=' + params.placement_id + '&'; 
